...
class TestLostItemImporter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #on donne une fausse bdd, testée que le temps du test, sera suppr juste aprés
        create_tables(self.engine)
        self.Session = sessionmaker(bind=self.engine)
        self.session = self.Session()
        self.importer = LostItemImporter(self.engine)
        #j'instancie lostitem, avec bdd fake
    ...
    def test__get_year_range(self):
        ...
        for year_range in year_ranges:
            ...
            #tous les tests doivent ê à ce format ci
    ...
    def test__create_endpoint(self):
        ...
        #comparaison entre la fction endpoint et resultat attendu de cette fction!
